...
```
タスクファイル: .specify/features/xxx/tasks.md
実行Phase: Phase 3
...
前Phase出力: .specify/features/xxx/tasks/ph2-output.md
RED テスト情報: .specify/features/xxx/red-tests/ph3-test.md  # TDD Phase の場合のみ

コンテキスト:
- プロジェクト概要: 動画から書籍テキストを抽出するパイプライン
- 技術スタック: Python 3.13+, pytest, Pillow, requests
```
